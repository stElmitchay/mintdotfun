    ...
    >
      <div className="relative h-64 overflow-hidden">
        {listing.nftImageUrl ? (
          ...
          <div className="w-full h-full bg-gradient-to-br from-purple-500/40 to-pink-500/40 flex items-center justify-center group-hover:scale-110 transition-transform duration-500">
